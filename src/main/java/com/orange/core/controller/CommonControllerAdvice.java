...
public class CommonControllerAdvice {
    ...
    public ResultBean handleHttpException(HttpRequestMethodNotSupportedException exception) {
        ...
        return ResultBean.format(new ServiceException(ServiceCode.ILLEGAL_PARAM, "不支持的HTTP '" + exception.getMethod() + "' 请求"));
    }
    ...
    public ResultBean handleIOException(JsonParseException exception) {
        ...
        return ResultBean.format(new ServiceException(ServiceCode.SYSTEM_ERROR, exception.getMessage()));
    }
